...
class Arm:
    ...
    def set_end_effector_target_position(self, target_position: np.ndarray, initial_motor_radians: List[float] | None, gripper_open_degrees: float, gripper_rotate_degrees: float) -> List[float]:
