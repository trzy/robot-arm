...
#
# Server outputs episodes in the following directory structure:
#
#   dirname/
#       example-0/
#           data.hdf5
...
#       ...
#
# This script will place episodes at the root of the directory:
#
#   dirname/
#       episode_0.hdf5
#       episode_1.hdf5
...
if __name__ == "__main__":
    ...
    for i in range(len(dirs)):
        dir = dirs[i]
        file = os.path.join(dir, "data.hdf5")
        files.append(file)
